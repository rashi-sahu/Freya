#! /bin/bash
echo "Creating working directory /app/stormslaves/"
sudo mkdir -p /app/stormslaves
sudo chown -R stormuser:storm /app/stormslaves
sudo chmod 750 /app/stormslaves
...
sudo echo "storm.zookeeper.servers:
 - "$1"
storm.local.dir: “/app/stormslaves”
nimbus.host: "$1"
